...
public class Lipstick extends Fragment {
    ...
    public static Lipstick newInstance(String param1, String param2) {
        Lipstick fragment = new Lipstick();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_lipstick, container, false);
        list_product = v.findViewById(R.id.list_product_liptick);
    ...
    public void loafProduct () {
        AsyncHttpApi.get(getActivity().getSharedPreferences("data", Context.MODE_PRIVATE).getString("token",""),"/products/cator/lipstick", null, new JsonHttpResponseHandler() {
