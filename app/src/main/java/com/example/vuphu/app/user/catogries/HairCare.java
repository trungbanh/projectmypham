...
public class HairCare extends Fragment {
    ...
    public static HairCare newInstance() {
        HairCare fragment = new HairCare();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_hair_care, container, false);
        list_product = v.findViewById(R.id.list_product_hair_care);
    ...
    public void loafProduct () {
        AsyncHttpApi.get(getActivity().getSharedPreferences("data", Context.MODE_PRIVATE).getString("token",""),"/products/cator/hair care", null, new JsonHttpResponseHandler() {
