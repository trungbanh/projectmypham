...
public class SkinCare extends Fragment {
    ...
    public static SkinCare newInstance() {
        SkinCare fragment = new SkinCare();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_skin_care, container, false);
        list_product = v.findViewById(R.id.list_product_skin_care);
    ...
    public void loafProduct () {
        AsyncHttpApi.get(getActivity().getSharedPreferences("data", Context.MODE_PRIVATE).getString("token",""),
                "/products/cator/skin care cosmetics", null, new JsonHttpResponseHandler() {
            @Override
