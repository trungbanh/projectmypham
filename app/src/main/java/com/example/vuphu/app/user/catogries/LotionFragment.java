...
public class LotionFragment extends Fragment {

    private RecyclerView list_product;
    private ArrayList<Product> product;

    public LotionFragment() {
        // Required empty public constructor
    }
    public static LotionFragment newInstance() {
        LotionFragment fragment = new LotionFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_lotion, container, false);

        list_product = v.findViewById(R.id.list_product_lotion);
    ...
    public void loafProduct () {
        AsyncHttpApi.get(getActivity().getSharedPreferences("data", Context.MODE_PRIVATE).getString("token",""),"/products/cator/lotion", null, new JsonHttpResponseHandler() {
